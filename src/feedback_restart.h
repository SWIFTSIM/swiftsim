 ...
 *
 ******************************************************************************/
#ifndef SWIFT_FEEDBACK_RESTART_H
#define SWIFT_FEEDBACK_RESTART_H
...
#include "./feedback/none/feedback_restart.h"
#elif defined(FEEDBACK_EAGLE)
#include "./feedback/EAGLE/feedback_restart.h"
#else
#error "Invalid choice of feedback model"
#endif

#endif /* SWIFT_FEEDBACK_RESTART_H */
