...
struct gasVariables {
  ...
  ChimesFloat
      element_abundances[10]; /*!< Element abundances, in the order: He, C, N,
                                 O, Ne, Mg, Si, S, Ca, Fe. */
  ...
  ChimesFloat
      doppler_broad; /*!< Doppler broadening from turbulence only (thermal
                        broadening is added separately). Units: km s^-1. */
  ChimesFloat
      *isotropic_photon_density; /*!< Isotropic photon density (i.e. flux
                                    divided by the speed of light) for each
                                    spectrum. Units: cm^-3 */
  ChimesFloat *G0_parameter; /*!< Strength of the 6-13.6 eV FUV band for each
                                spectrum. Units: Habing. */
  ChimesFloat *H2_dissocJ;   /*!< n / (isotropic_photon_density * c) for each
                                spectrum, where n is photon number density in
                                the 12.24-13.51 eV band. */
  ChimesFloat cr_rate; /*!< HI ionisation rate from cosmic rays. Units: s^-1. */
  ChimesFloat
      metallicity; /*!< Metallicity relative to solar (where Z_sol = 0.0129). */
  ChimesFloat dust_ratio; /*!< Dust-to-gas ratio relative to the Milky Way. */
  ChimesFloat cell_size;  /*!< Shielding length. Units: cm. */
  ChimesFloat hydro_timestep; /*!< Total time over which to integrate the
                                 chemistry and cooling. Units: s. */
  ...
  int temp_floor_mode; /*!< Flag to control how the temperature floor is
                          implemented. */
  ...
  ChimesFloat constant_heating_rate; /*!< Extra heating term to add to the
                                        radiative cooling rates (positive for
...
struct globalVariables {
  ...
  int redshift_dependent_UVB_index;      /*!< Specifies which of the UV spectra
                                            corresponds to the redshift-dependent
                                            UVB. */
  int use_redshift_dependent_eqm_tables; /*!< Use redshift-dependent eqm
                                            abundance tables if this flag is set
                                            to 1. */
  ChimesFloat redshift;                  /*!< Current redshift. */
  ChimesFloat reionisation_redshift;     /*!< Before this redshift, the
                                            redshift-dependent UVB is set to zero.
                                          */
  int StaticMolCooling; /*!< For CO and H2O cooling, use: 0 - thermal velocity
                           dispersion; 1 - velocity divergence. */
  ChimesFloat T_mol;    /*!< Disable molecules above this temperature. */
  ChimesFloat grain_temperature; /*!< Grain temperature used in the H2 formation
                                    rate on dust. */
  ChimesFloat cmb_temperature; /*!< CMB temperature used for Compton cooling. */
  ChimesFloat relativeTolerance; /*!< Relative tolerance used in the CVODE
                                    integration. */
  ...
  void (*allocate_gas_hybrid_data_fn)(
      struct gasVariables *myGasVars); /*!< Allocate memory for the gasVars
                                          hybrid_data struct. */
  void (*free_gas_hybrid_data_fn)(
      struct gasVariables
          *myGasVars); /*!< Free memory for the gasVars hybrid_data struct. */
};
...
struct UserData {
  ...
  struct chimes_current_rates_struct
      *chimes_current_rates; /*!< The #chimes_current_rates_struct struct. */
...
extern struct chimes_table_bins_struct {
  ...
  int N_secondary_cosmic_ray_xHII; /*!< Number of xHII bins for secondary cosmic
                                      ray reactions. */
  ChimesFloat *secondary_cosmic_ray_xHII; /*!< xHII array for secondary cosmic
                                             ray reactions. */
  int N_Column_densities;                 /*!< Number of column density bins. */
  ChimesFloat *Column_densities;          /*!< Column density array. */
  int N_H2self_column_densities; /*!< Number of H2 column density bins for H2
                                    self-shielding. */
  ChimesFloat *H2self_column_densities; /*!< H2 column density array for H2
                                           self-shielding. */
  int N_b_turbulence; /*!< Number of turbulent doppler broadening bins for H2
                         self-shielding. */
  ChimesFloat *b_turbulence;     /*!< Turbulent doppler broadening array for H2
                                    self-shielding. */
  int N_COself_column_densities; /*!< Number of CO column density bins for CO
                                    self-shielding. */
  ChimesFloat *COself_column_densities; /*!< CO column density array for CO
                                           self-shielding. */
  int N_H2CO_column_densities; /*!< Number of H2 column density bins for CO
                                  shielding. */
  ChimesFloat
      *H2CO_column_densities;  /*!< H2 column density array for CO shielding. */
  int N_mol_cool_Temperatures; /*!< Number of temperature bins for molecular
                                  cooling. */
  ChimesFloat
  ...
  ChimesFloat *H2O_cool_rot_ColumnDensities; /*!< H2O column density array for
                                                H2O rotational cooling. */
  int N_H2O_cool_vib_ColumnDensities; /*!< Number of H2O column density bins for
  ...
  ChimesFloat *cool_hiT_2d_Temperatures; /*!< Temperature array for the 2-d
                                            ...
                                            temperature. */
  int N_cool_2d_ElectronDensities; /*!< Number of electron density bins for the
  ...
  ChimesFloat *cool_hiT_4d_Temperatures; /*!< Temperature array for the 4-d
                                            cooling channels at high
                                            temperature. */
  int N_cool_4d_HIDensities; /*!< Number of HI density bins for the 4-d cooling
                                channels. */
  ChimesFloat *cool_4d_HIDensities; /*!< HI density array for the 4-d cooling
                                       channels. */
  int N_cool_4d_ElectronDensities;  /*!< Number of electron density bins for the
...
extern struct chimes_T_dependent_struct {
  int N_reactions[2]; /*!< Number of reactions, excluding and including
                         molecules. */
  ...
  int H2_collis_dissoc_heating_reaction_index; /*!< Index pointing to the H2
                                                  ...
                                                  reaction. Needed for the
                                                  associated heating. */
  int H2_form_heating_reaction_index; /*!< Index pointing to the H2 gas-phase
                                         formation reaction. Needed for the
                                         associated heating. */
  ChimesFloat **rates; /*!< Arrays containing the rate coefficients as a
                          function of temperature for each reaction. */
...
extern struct chimes_constant_struct {
  ...
  int H2_form_heating_reaction_index; /*!< Index pointing to the H2 gas-phase
                                         formation reaction. Needed for the
                                         associated heating. */
  ChimesFloat *rates; /*!< Array containing the constant rate coefficients for
                         each reaction. */
...
extern struct chimes_recombination_AB_struct {
  ...
  int *molecular_flag;  /*!< Flags indicating whether each reaction involves
                           molecules. */
  ChimesFloat ***rates; /*!< Arrays containing the rate coefficients as a
                           function of temperature, for case A and case B
                           recombinations separately.*/
...
extern struct chimes_grain_recombination_struct {
  ...
  int **element_incl; /*!< Flags indicating which elements are required for each
                         reaction. */
  ChimesFloat ***rates; /*!< Arrays containing the rate coefficients as a
                           function of temperature and Psi for each reaction. */
...
extern struct chimes_cosmic_ray_struct {
  ...
  int *secondary_base_reaction;  /*!< Indices of the HI and HeI CR reactions.
                                    Needed for secondary ionisations. */
  ChimesFloat **secondary_ratio; /*!< Ratio of secondary to primary CR
                                    ionisation of HI and HeI, as a function of
                                    xHII. */
...
extern struct chimes_H2_dust_formation_struct {
  ...
  ChimesFloat **rates; /*!< Array of the rate coefficient as a function of gas
...
extern struct chimes_H2_collis_dissoc_struct {
  ...
  int **reactants;            /*!< Reactants for each reaction. */
  int **products;             /*!< Products for each reaction. */
  int Heating_reaction_index; /*!< Index of the collisional dissociation
                                 reaction that contributes to heating. */
  ChimesFloat **k0;   /*!< Arrays of the low-density rate coefficients as a
                         function of temperature for each reaction. */
  ChimesFloat **kLTE; /*!< Arrays of the LTE rate coefficients as a function of
                         temperature for each reaction. */
  ChimesFloat *critical_density_H; /*!< Array of the critical density for HI
...
extern struct chimes_photoion_fuv_struct {
  ...
  ChimesFloat *
      *epsilonPhot; /*!< Arrays of the average excess photon energy for each
                       reaction and each spectrum. Units: erg */
...
extern struct chimes_photoion_euv_struct {
  ...
  ChimesFloat **sigmaPhot; /*!< Arrays of the cross sections for each reaction
                              and each spectrum. Units: cm^-2 */
  ChimesFloat ***
      *shieldFactor_1D; /*!< Arrays of the shield factor components in 1D (as a
                           function of 1 column density) for each reaction. */
  ChimesFloat ****
...
extern struct chimes_CO_photodissoc_struct {
  ...
  ChimesFloat ***self_shielding; /*!< Array of the CO self-shielding factor as a
                                    function CO and H2 column densities. */
...
extern struct chimes_cooling_struct {
  ...
  int *coolants_4d;  /*!< The species corresponding to each 4-d cooling channel.
                      */
  ChimesFloat **rates; /*!< Arrays of the rates for each standard cooling
                          channel as a function of temperature. */
  ChimesFloat **
      *rates_2d; /*!< Arrays of the low-temperature rates for each 2-d cooling
                    channel as a function of temperature and ne. */
  ChimesFloat *****rates_4d; /*!< Arrays of the low-temperature rates for each
                                4-d cooling channel as a function of
                                temperature, ne, nHI and nHII. */
  ChimesFloat *
      *rates_hiT_2d; /*!< Arrays of the high-temperature rates for each 2-d
                        cooling channel as a function of temperature. */
  ChimesFloat *
      *rates_hiT_4d; /*!< Arrays of the high-temperature rates for each 4-d
                        cooling channel as a function of temperature. */
  ChimesFloat **photoelectric_heating; /*!< Photoelectric heating rate as a
                                          function of temperature and Psi. */
  ChimesFloat *gas_grain_transfer;     /*!< Gas-dust transfer cooling rate as a
                                          function of temperature. */
  ChimesFloat *
      *grain_recombination; /*!< Grain recombination cooling rate as a function
                               of temperature and Psi. */
  ChimesFloat *H2_cool_lowDens_H2; /*!< Low-density H2 rovibrational cooling
                                      rate from H2 collisions as a function of
                                      temperature. */
  ...
  ChimesFloat *H2_cool_lowDens_elec; /*!< Low-density H2 rovibrational cooling
                                        ...
                                        function of temperature. */
  ChimesFloat
      *H2_cool_LTE; /*!< LTE H2 rovibrational cooling rate as a function of
                       temperature. */
  ChimesFloat *CO_cool_rot_L0; /*!< CO rotational cooling L0 as a function of
                                  temperature. */
  ChimesFloat *
      *CO_cool_rot_Llte; /*!< CO rotational cooling Llte as a function of
                            temperature and CO column density. */
  ChimesFloat **CO_cool_rot_nhalf; /*!< CO rotational cooling nhalf as a
                                      function of temperature and CO column
                                      density. */
  ChimesFloat **CO_cool_rot_a;     /*!< CO rotational cooling a as a function of
                                      temperature and CO column density. */
  ChimesFloat *CO_cool_vib_L0; /*!< CO vibrational cooling L0 as a function of
                                  temperature. */
  ChimesFloat *
  ...
  ChimesFloat *H2Oortho_cool_rot_lowT_L0; /*!< ortho-H2O rotational cooling
                                             ...
                                             temperature. */
  ChimesFloat *
      *H2Oortho_cool_rot_lowT_Llte; /*!< ortho-H2O rotational cooling
                                       low-temperature Llte as a function of
                                       temperature and H2O column density. */
  ChimesFloat *
      *H2Oortho_cool_rot_lowT_nhalf; /*!< ortho-H2O rotational cooling
  ...
  ChimesFloat *H2Opara_cool_rot_lowT_L0;    /*!< para-H2O rotational cooling
                                               low-temperature L0 as a function of
                                               temperature. */
  ChimesFloat **H2Opara_cool_rot_lowT_Llte; /*!< para-H2O rotational cooling
                                               low-temperature Llte as a
                                               function of temperature and H2O
                                               column density. */
  ChimesFloat *
      *H2Opara_cool_rot_lowT_nhalf; /*!< para-H2O rotational cooling
                                       low-temperature nhalf as a function of
                                       temperature and H2O column density. */
  ChimesFloat *
      *H2Opara_cool_rot_lowT_a; /*!< para-H2O rotational cooling
                                   low-temperature a as a function of
                                   temperature and H2O column density. */
...
extern struct chimes_redshift_dependent_UVB_struct {
  ...
  ChimesFloat *
      *photoion_fuv_sigmaPhot; /*!< Cross sections for the photoion_fuv group
                                  from the two redshift bins. */
  ChimesFloat *
      *photoion_fuv_epsilonPhot; /*!< Average excess photon energies for the
                                    photoion_euv group from the two redshift
                                    bins. */
  ChimesFloat *
      *photoion_euv_sigmaPhot; /*!< Cross sections for the photoion_euv group
                                  from the two redshift bins. */
  ChimesFloat ***
      *photoion_euv_shieldFactor_1D; /*!< 1D shield factor components for the
                                        photoion_euv group from the two
                                        redshift bins. */
  ChimesFloat ****
      *photoion_euv_shieldFactor_2D; /*!< 2D shield factor components for the
                                        photoion_euv group from the two
                                        redshift bins. */
  ChimesFloat **photoion_auger_fuv_sigmaPhot; /*!< Cross sections for the
                                                 photoion_auger_fuv group from
                                                 the two redshift bins. */
  ChimesFloat **photoion_auger_euv_sigmaPhot; /*!< Cross sections for the
                                                 photoion_auger_euv group from
                                                 the two redshift bins. */
  ChimesFloat isotropic_photon_density[2];    /*!< Isotropic photon density from
                                                 the two redshift bins. */
  ChimesFloat G0_parameter
      [2]; /*!< Strength of the 6-13.6 FUV band from the two redshift bins. */
  ChimesFloat
  ...
  int **photoion_euv_element_incl; /*!< Flags indicating which elements are
                                      required for each reaction in the
                                      photoion_euv group. */
  int **photoion_auger_fuv_element_incl; /*!< Flags indicating which elements
                                            are required for each reaction in
                                            the photoion_auger_fuv group. */
  int **photoion_auger_euv_element_incl; /*!< Flags indicating which elements
                                            are required for each reaction in
                                            the photoion_auger_euv group. */
...
struct chimes_current_rates_struct {
  ...
  ChimesFloat **data_buffer_2d; /*!< Memory buffer for all 2-d arrays. */
  ChimesFloat
      *T_dependent_rate_coefficient; /*!< Current rate coefficients for the
                                        T_dependent group. */
  ChimesFloat
  ...
  ChimesFloat *grain_recombination_rate_coefficient; /*!< Current rate
                                                        ...
                                                        grain_recombination
                                                        group. */
  ChimesFloat *grain_recombination_rate;             /*!< Current rates for the
                                                        grain_recombination group. */
  ChimesFloat *cosmic_ray_rate; /*!< Current rates for the cosmic_ray group. */
  ChimesFloat *CO_cosmic_ray_rate_coefficient; /*!< Current rate coefficients
                                                  for the CO_cosmic_ray group.
                                                */
  ChimesFloat
      *CO_cosmic_ray_rate; /*!< Current rates for the CO_cosmic_ray group. */
  ChimesFloat H2_dust_formation_rate_coefficient; /*!< Current rate coefficients
                                                     for the H2_dust_formation
                                                     group. */
  ...
  ChimesFloat
      H2_collis_dissoc_crit_He; /*!< Current critical densities from HeI
                                   collisions for the H2_collis_dissoc group. */
  ChimesFloat
      *H2_collis_dissoc_log_k0; /*!< Current low-density rate coefficients for
                                   the H2_collis_dissoc group. */
  ChimesFloat
      *H2_collis_dissoc_log_kLTE; /*!< Current LTE rate coefficients for the
                                     H2_collis_dissoc group. */
  ChimesFloat *photoion_fuv_shield_factor; /*!< Current shield factors for the
                                              photoion_fuv group. */
  ChimesFloat
      *photoion_fuv_rate_coefficient; /*!< Current rate coefficients for the
                                         photoion_fuv group. */
  ChimesFloat
      *photoion_fuv_rate; /*!< Current rates for the photoion_fuv group. */
  ChimesFloat *photoion_fuv_heat_rate;      /*!< Current heating rates for the
                                               photoion_fuv group. */
  ChimesFloat **photoion_euv_shield_factor; /*!< Current shield factors for the
                                               photoion_euv group. */
  ChimesFloat
      *photoion_euv_rate_coefficient; /*!< Current rate coefficients for the
                                         photoion_euv group. */
  ChimesFloat
      *photoion_euv_rate; /*!< Current rates for the photoion_euv group. */
  ChimesFloat **photoion_euv_epsilon;  /*!< Current excess photon energies for
                                          the photoion_euv group. */
  ChimesFloat *photoion_euv_heat_rate; /*!< Current heating rates for the
                                          photoion_euv group. */
  ChimesFloat
      *photoion_auger_fuv_rate_coefficient; /*!< Current rate coefficients for
                                               the photoion_auger_fuv group. */
  ChimesFloat *photoion_auger_fuv_rate;     /*!< Current rates for the
                                               photoion_auger_fuv group. */
  ChimesFloat
      *photoion_auger_euv_rate_coefficient; /*!< Current rate coefficients for
                                               the photoion_auger_euv group. */
  ChimesFloat *photoion_auger_euv_rate;     /*!< Current rates for the
                                               photoion_auger_euv group. */
  ChimesFloat
      *photodissoc_group1_shield_factor; /*!< Current shield factors for the
                                            photodissoc_group1 group. */
  ChimesFloat
      *photodissoc_group1_rate_coefficient; /*!< Current rate coefficients for
                                               the photodissoc_group1 group. */
  ChimesFloat *photodissoc_group1_rate;     /*!< Current rates for the
                                               photodissoc_group1 group. */
  ChimesFloat
  ...
  ChimesFloat
      *CO_photodissoc_rate_coefficient; /*!< Current rate coefficients for the
                                           CO_photodissoc group. */
  ChimesFloat
      *CO_photodissoc_rate; /*!< Current rates for the CO_photodissoc group. */
  ChimesFloat
      *cooling_rate; /*!< Current rates for the standard cooling channels. */
  ChimesFloat
      *cooling_rate_2d; /*!< Current rates for the 2-d cooling channels. */
  ChimesFloat
      *cooling_rate_4d; /*!< Current rates for the 4-d cooling channels. */
};
...
// rate_equations.c
void check_constraint_equations(struct gasVariables *myGasVars,
                                struct globalVariables *myGlobalVars);
