...
__attribute__((always_inline)) INLINE static int star_formation_write_sparticles(
  ...
  list[0] = io_make_output_field(
       "BirthDensities", FLOAT, 1, UNIT_CONV_DENSITY, 0.f, sparts, sf_data.birth_density,
  ...
  list[1] = io_make_output_field("BirthTemperatures", FLOAT, 1, UNIT_CONV_TEMPERATURE,
  ...
  list[3] = io_make_output_field("ProgenitorIDs", LONGLONG, 1,
                                  UNIT_CONV_NO_UNITS, 0.f, sparts, sf_data.progenitor_id,
