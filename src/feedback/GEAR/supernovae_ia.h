...
int supernovae_ia_can_explode(const struct supernovae_ia *snia,
                              float m_low, float m_high);
const float *supernovae_ia_get_yields(const struct supernovae_ia *snia);
float supernovae_ia_get_ejected_mass_processed(const struct supernovae_ia *snia);
float supernovae_ia_get_companion_fraction(const struct supernovae_ia *snia, float m1,
                                           float m2, int companion_type);
float supernovae_ia_get_number(const struct supernovae_ia *snia,
                               float m1, float m2);

void supernovae_ia_read_yields(
