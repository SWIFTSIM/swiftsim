...
int supernovae_ii_can_explode(const struct supernovae_ii *snii,
                              float m_low, float m_high);
float supernovae_ii_get_number(const struct supernovae_ii *snii,
                               float m1, float m2);
void supernovae_ii_get_yields(const struct supernovae_ii *snii,
...
void supernovae_ii_dump(
    ...
    const struct stellar_model *sm);
void supernovae_ii_restore(struct supernovae_ii *snii,
