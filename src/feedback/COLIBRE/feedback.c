...
void feedback_props_init(struct feedback_props* fp,
  ...
  fp->delta_time_feedback_logger_Myr = parser_get_param_double(
      params, "COLIBREFeedback:delta_time_feedback_logger_Myr");
  fp->delta_time_feedback_logger =
      fp->delta_time_feedback_logger_Myr * 1e6 * phys_const->const_year;
  message("%e %e", fp->delta_time_feedback_logger_Myr,
          fp->delta_time_feedback_logger);
