 ...
 *
 ******************************************************************************/
#ifndef SWIFT_DENSITY_ENERGY_HYDRO_DEBUG_H
#define SWIFT_DENSITY_ENERGY_HYDRO_DEBUG_H

/**
 * @file DensityEnergy/hydro_debug.h
 * @brief DensityEnergy conservative implementation of SPH (Debugging
 * routines)
 *
