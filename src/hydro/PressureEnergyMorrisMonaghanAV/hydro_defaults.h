...
#ifndef SWIFT_PRESSURE_ENERGY_MORRIS_HYDRO_DEFAULT_H
#define SWIFT_PRESSURE_ENERGY_MORRIS_HYDRO_DEFAULT_H

/**
 * @file PressureEnergyMorrisMonaghanAV/hydro_defaults.h
...
#endif /* SWIFT_PRESSURE_ENERGY_MORRIS_HYDRO_DEFAULT_H */