...
#ifndef SWIFT_SHADOWSWIFT_HYDRO_DEFAULT_H
#define SWIFT_SHADOWSWIFT_HYDRO_DEFAULT_H

/**
 * @file Shadowswift/hydro_defaults.h
...
#endif /* SWIFT_SHADOWSWIFT_HYDRO_DEFAULT_H */