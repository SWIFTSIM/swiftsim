...
#ifndef SWIFT_PRESSURE_ENTROPY_HYDRO_DEFAULT_H
#define SWIFT_PRESSURE_ENTROPY_HYDRO_DEFAULT_H

/**
 * @file PressureEnergy/hydro_defaults.h
...
#endif /* SWIFT_PRESSURE_ENTROPY_HYDRO_DEFAULT_H */