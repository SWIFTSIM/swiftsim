...
// static const char *chemistry_logger_field_names[chemistry_logger_field_part_count] = {};
// static const char *chemistry_logger_field_names[chemistry_logger_field_spart_count] = {};
