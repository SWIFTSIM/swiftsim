...
struct rt_spart_data {
  ...
  /* data to store during entire run */
  unsigned long long debug_radiation_emitted_tot; /* how much radiation this star emitted during total lifetime */

  /* data to store during one time step */
  int debug_iact_hydro_inject; /* how many hydro particles this particle interacted with */
