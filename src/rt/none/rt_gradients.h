 ...
 *
 ******************************************************************************/
#ifndef SWIFT_RT_GRADIENTS_NONE_H
#define SWIFT_RT_GRADIENTS_NONE_H

/**
 * @file src/rt/none/rt_gradients.h
 * @brief Main header file for the none radiative transfer scheme gradients
 */
