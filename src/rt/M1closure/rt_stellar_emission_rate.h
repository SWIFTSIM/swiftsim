 ...
 *
 ******************************************************************************/
#ifndef SWIFT_RT_STELLAR_EMISSION_RATE_NONE_H
#define SWIFT_RT_STELLAR_EMISSION_RATE_NONE_H

/**
 * @file src/rt/none/rt_stellar_emission_rate.h
...
#endif /* SWIFT_RT_STELLAR_EMISSION_RATE_NONE_H */
