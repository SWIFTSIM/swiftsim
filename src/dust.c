...
void dustevo_props_init(struct dustevo_props *dustevo_properties,
  ...
  dustevo_properties->comp_Ide[chemistry_element_He] = 0.;
  dustevo_properties->comp_Ide[chemistry_element_C] = 0.;
  dustevo_properties->comp_Ide[chemistry_element_N] = 0.;
  dustevo_properties->comp_Ide[chemistry_element_O] = 0.;
