...
enum {
  ...
  timer_kick,
  timer_dosort,
  timer_doself_hydro_loop1,
  timer_doself_hydro_loop2,
  timer_doself_hydro_loop3,
  timer_doself_hydro_loop4,
  timer_doself_grav,
  timer_dopair_hydro_loop1,
  timer_dopair_hydro_loop2,
  timer_dopair_hydro_loop3,
  timer_dopair_hydro_loop4,
  timer_dopair_grav,
  timer_dosub_hydro_loop1,
  timer_dosub_hydro_loop2,
  timer_dosub_hydro_loop3,
  timer_dosub_hydro_loop4,
  timer_dosub_grav,
  timer_dopair_subset,
  timer_doghost1,
  timer_doghost2,
