 ...
 *
 ******************************************************************************/
#ifndef SWIFT_COLIBRE_EVENT_LOGGER_SNII_H
#define SWIFT_COLIBRE_EVENT_LOGGER_SNII_H
...
INLINE static void event_logger_SNII_log_data(const struct engine *e) {
  ...
  /* We need to log */
  event_logger_SNII_log_data_general(e, log_SNII.core.delta_logger_time);
...
#endif /* SWIFT_COLIBRE_EVENT_LOGGER_SNII_H */
