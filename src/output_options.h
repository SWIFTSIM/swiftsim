...
#define select_output_default_subsample_ratio -1.f
...
struct output_options {
  ...
  /*! Subsample ratios to use for the snapshots of the given selection
   * If set to the default, the code will use the name set in the
   * snapshot section of the param file. */
  float subsample_ratios[OUTPUT_LIST_MAX_NUM_OF_SELECT_OUTPUT_STYLES + 1]
                        [swift_type_count];
};
